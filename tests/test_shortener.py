...
class TestShortener(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.shortener = Shortener(self.short_base_url, self.urls_collection_mock, hash_generator)
    ...
    def test_same_url_is_minified_to_same_hash(self):
        ...
        self.urls_collection_mock.find_one.return_value = {"hash": '4a040', "url": self.long_url}
    ...
    def test_hash_generation_avoids_collisions(self):
        ...
        hash_generator.generate.side_effect = ["hash", "hash", "unique_hash1", "unique_hash2"]
        ...
        self.urls_collection_mock.find_one.side_effect = [None, {"url": "http//example.com/1"}, None]

        shortener = Shortener(self.short_base_url, self.urls_collection_mock, hash_generator)
        ...
        self.urls_collection_mock.insert_one.assert_any_call({"hash": "hash", "url": "http//example.com/1", "createdAt": ANY})
        self.urls_collection_mock.insert_one.assert_any_call({"hash": "unique_hash1", "url": "http//example.com/2", "createdAt": ANY})
