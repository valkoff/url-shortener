...
class Shortener:
    ...
    def __init__(self, base_url: str, urls_collection: collection.Collection, hash_generator: HashGenerator):
    ...
    def minify(self, url) -> str:
        ...
        raise CannotGenerateUniqueHashException("Cannot generate a unique hash for the URL")
